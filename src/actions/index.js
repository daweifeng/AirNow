...
const getNewAirData = async (location) => {
  ...
  const airData = await axios.get(`http://www.airnowapi.org/aq/observation/latLong/current/?format=application/json&latitude=37.936&longitude=-122.0262&distance=25&API_KEY=CFE97C56-8C64-49C2-BA8C-10652F3442C2`)
